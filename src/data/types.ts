...
export interface City {
  ...
  /** Ключ «фирменного» кадра города (хаб-герой + карточка в блоке географии). */
  heroImage?: string;
  /** Ключи медиа для локальной галереи (из реестра lib/media). */
  media: string[];
...
export interface Service {
  ...
  icon: string;
  /** Ключ изображения интент-карточки/карточки услуги (реестр lib/media). */
  cardImage?: string;
  /** Ключ кадра-героя на хабе услуги. */
  heroImage?: string;
  /** Ключи доп. кадров для галереи услуги. */
  gallery?: string[];
